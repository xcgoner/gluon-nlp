...
mpirun -np 8 -machinefile $PBS_O_WORKDIR/hostfile_local_8 -ppn 2 -genv I_MPI_PIN_DOMAIN auto:compact \
                       python train_transformer_hvd_local_v1.py --dataset WMT2014BPE \
                       --src_lang en --tgt_lang de --batch_size 10800 \
                       --optimizer adam --num_accumulated 4 --lr 3.0 --warmup_steps 3000 \
                       ...
                       --local_sgd_interval 6 2>&1 | tee -a $watchfile
