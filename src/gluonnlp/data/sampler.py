...
__all__ = ['ConstWidthBucket', 'LinearWidthBucket', 'ExpWidthBucket',
           'SortedSampler', 'FixedBucketSampler', 'SortedBucketSampler', 'SplitSampler', 'SplitFixedBucketSampler']
...
class SplitFixedBucketSampler(FixedBucketSampler):
    def __init__(self, lengths, batch_size, num_buckets=10, bucket_keys=None,
        ...
        super(SplitFixedBucketSampler, self).__init__(lengths, batch_size, num_buckets=num_buckets, bucket_keys=bucket_keys,
                 ratio=ratio, shuffle=shuffle, use_average_length=use_average_length, num_shards=num_parts,
