#!/bin/bash
#PBS -l select=4:ncpus=112 -lplace=excl
...
watchfile=/homes/cx2/src/localadam/uai2020/results/train_transformer_hvd_8.txt

cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile_8
cd /homes/cx2/src/localadam/uai2020/gluon-nlp/scripts/machine_translation
mpirun -np 8 -machinefile $PBS_O_WORKDIR/hostfile_8 -ppn 2 -genv I_MPI_PIN_DOMAIN auto:compact \
