...
from gluonnlp.optimizer.local_sgd_v3 import LocalSGDTrainerV3
...
parser.add_argument('--local_average', type=int, default=5, help='the number of average after sync')
...
def train():
    ...
    if args.local_average > local_sgd:
        local_average = local_sgd
    else:
        local_average = args.local_average

    trainer = LocalSGDTrainerV3(model.collect_params(), args.optimizer,
