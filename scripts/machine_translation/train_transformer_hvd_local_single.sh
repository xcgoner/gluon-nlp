...
watchfile=/homes/cx2/src/localadam/uai2020/results/train_transformer_hvd_local_v1.txt

cd /homes/cx2/src/localadam/uai2020/gluon-nlp/scripts/machine_translation
mpirun -np 2 -host localhost -ppn 2 -genv I_MPI_PIN_DOMAIN auto:compact \
