...
from gluonnlp.optimizer.hier_sgd import DistributedHierTrainer
...
def train(data_train, data_eval, model, nsp_loss, mlm_loss, vocab_size, ctx, store):
    ...
    running_mlm_loss, running_nsp_loss, running_num_tks = 0, 0, 0
    batch_num = 0
    ...
    while step_num < num_train_steps:
        for _, dataloader in enumerate(data_train):
            ...
            if args.dummy_data_len:
                target_shape = (int(args.batch_size*num_ctxes / args.dummy_data_len), args.dummy_data_len)
