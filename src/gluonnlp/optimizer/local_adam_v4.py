...
class LocalAdamV4(Optimizer):
    ...
    **lazy updates** at step t are applied by::
    ...
    def __init__(self, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8, 
                 local_sgd_warmup = 800,
                 lazy_update=True, **kwargs):
        super(LocalAdamV4, self).__init__(learning_rate=learning_rate, **kwargs)
        self.beta1 = beta1
        self.beta2 = beta2
        self.epsilon = epsilon
        self.lazy_update = lazy_update

        self.local_sgd_warmup = local_sgd_warmup
